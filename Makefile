...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Jul 21 13:48:58 2016
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/comedirecord1.0.0/ && $(COPY_FILE) --parents comedirecord.h comediscope.h gain.h ext_data_receive.h dc_sub.h hp.h lp.h fftscope.h channel.h led.h axis.h .tmp/comedirecord1.0.0/ && $(COPY_FILE) --parents comedirecord.cpp comediscope.cpp gain.cpp ext_data_receive.cpp dc_sub.cpp lp.cpp hp.cpp fftscope.cpp channel.cpp led.cpp axis.cpp .tmp/comedirecord1.0.0/ && (cd `dirname .tmp/comedirecord1.0.0` && $(TAR) comedirecord1.0.0.tar comedirecord1.0.0 && $(COMPRESS) comedirecord1.0.0.tar) && $(MOVE) `dirname .tmp/comedirecord1.0.0`/comedirecord1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/comedirecord1.0.0
...
compiler_moc_header_make_all: moc_comedirecord.cpp moc_comediscope.cpp moc_gain.cpp moc_dc_sub.cpp moc_hp.cpp moc_lp.cpp moc_fftscope.cpp moc_channel.cpp moc_led.cpp moc_axis.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_comedirecord.cpp moc_comediscope.cpp moc_gain.cpp moc_dc_sub.cpp moc_hp.cpp moc_lp.cpp moc_fftscope.cpp moc_channel.cpp moc_led.cpp moc_axis.cpp
